...
let main argv =
    ...
    |> addGlobalOption (Option<string> "--Services:1:Name")
    |> addGlobalOption (Option<string> "--Services:1:Endpoint")
    |> addGlobalOption (Option<string> "--Services:1:Key")
    |> addGlobalOption (Option<string> "--Services:1:Model")
    |> addGlobalOption (Option<string> "--Services:1:SystemPrompt")
    |> addGlobalOption (Option<string> "--Services:1:UserPrompt")
    |> addGlobalOption (Option<string> "--Services:2:Name")
    |> addGlobalOption (Option<string> "--Services:2:Endpoint")
    |> addGlobalOption (Option<string> "--Services:2:Key")
    |> addGlobalOption (Option<string> "--Services:2:Model")
    |> addGlobalOption (Option<string> "--Services:2:SystemPrompt")
    |> addGlobalOption (Option<string> "--Services:2:UserPrompt")
