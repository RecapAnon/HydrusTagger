...
namespace HydrusAPI.NET.Extensions
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static void AddHydrusApi(this IServiceCollection services, Action<HostConfiguration> options)
        {
            HostConfiguration config = new(services);
            options(config);
            AddHydrusApi(services, config);
        }

        internal static void AddHydrusApi(IServiceCollection services, HostConfiguration host)
        {
            if (!host.HttpClientsAdded)
                host.AddHydrusApiHttpClients();
